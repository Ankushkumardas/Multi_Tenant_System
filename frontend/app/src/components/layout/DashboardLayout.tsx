    ...
    const sideItems = [
        ...
        },
        {
            ...
            items: [
                ...
                // { label: "Audit Trail", href: "settings/audit", icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-5.148L12 3m0 0l.45 1.582M12 3L10.5 4.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> },
